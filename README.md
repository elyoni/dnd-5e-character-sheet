...
- **Slow device mode** — skips the animated 3D dice throw and just shows the rolled number instantly, for older/slower devices where the physics animation lags. Global app preference like Theme, not saved per-character.
